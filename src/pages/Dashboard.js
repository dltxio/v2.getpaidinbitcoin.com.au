...
const Dashboard = () => {
  ...
  const { data: activeAddresses, error: fetchActiveAddressError } = useSWR(isVerified && `/user/${user.id}/address`);
  ...
  return (
    <Layout activeTab="Dashboard">
      <div className="dashboard container-fluid py-4">
        ...
        <VerificationTracker userDetails={userDetails} depositHints={depositHints} userEnterprise={userEnterprise} userAddress={userAddress} />
        <section className="main row">
          ...
          <aside className="col-lg-5">
            ...
            <Card>
              ...
              <p>
                Your current bitcoin address are listed here. To add and remove an address, and to view their history, go to your <b>address page.</b>
              </p>
